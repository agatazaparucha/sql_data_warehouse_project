...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM 'C:\Users\Agata\Desktop\sql-data-warehouse-project\sql-data-warehouse-project\datasets\source_crm\cust_info.csv'
        WITH (
        ...
        FROM 'C:\Users\Agata\Desktop\sql-data-warehouse-project\sql-data-warehouse-project\datasets\source_crm\prd_info.csv'
        WITH (
            FIRSTROW = 2, -- we have headers in the first row
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\Agata\Desktop\sql-data-warehouse-project\sql-data-warehouse-project\datasets\source_crm\sales_details.csv'
        WITH (
            FIRSTROW = 2, -- we have headers in the first row
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\Agata\Desktop\sql-data-warehouse-project\sql-data-warehouse-project\datasets\source_erp\cust_az12.csv'
        WITH (
            FIRSTROW = 2, -- we have headers in the first row
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\Agata\Desktop\sql-data-warehouse-project\sql-data-warehouse-project\datasets\source_erp\loc_a101.csv'
        WITH (
            FIRSTROW = 2, -- we have headers in the first row
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\Agata\Desktop\sql-data-warehouse-project\sql-data-warehouse-project\datasets\source_erp\px_cat_g1v2.csv'
        WITH (
            FIRSTROW = 2, -- we have headers in the first row
            FIELDTERMINATOR = ',',
            TABLOCK
